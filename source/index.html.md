...
<img src="./images/jupyterhub/image_2.png" width="550px" title="VS Code 안내" alt="VS Code 안내"></img>

<aside class="warning">
로컬 VS Code의 Remote-SSH를 통한 컴퓨트 노드 직접 접속은 <b>운영 정책상 허용되지 않습니다.</b><br>
...
<aside class="notice">
기존 conda 환경은 호환되지 않을 수 있으므로 새로 만드는 것을 권장합니다.<br>
...
<img src="./images/jupyterhub/image_3.png" width="550px" title="JupyterHub 로그인" alt="JupyterHub 로그인"></img>

- 위 링크로 접속 후 AI Center 서버 계정(Slurm)으로 로그인
- SSL 인증서 경고가 뜨면 "계속 진행" 클릭 (자체 서명 인증서이므로 정상)

<aside class="notice">
<b>(중요)</b> 자원 할당 신청 전, <b>Home</b>으로 이동하여 Named Server를 먼저 생성합니다.
</aside>

<img src="./images/jupyterhub/image_4_Home.png" width="550px" title="Home 화면" alt="Home 화면"></img>
...
<img src="./images/jupyterhub/image_5.png" width="550px" title="Named Server 추가" alt="Named Server 추가"></img>
...
<img src="./images/jupyterhub/image_6.png" width="550px" title="자원 선택 화면" alt="자원 선택 화면"></img>
...
<img src="./images/jupyterhub/image_7.png" width="550px" title="서버 시작" alt="서버 시작"></img>

### JupyterLab 사용

서버 시작 후 JupyterLab 인터페이스가 브라우저에 열립니다.

<img src="./images/jupyterhub/image_8.png" width="550px" title="JupyterLab 화면" alt="JupyterLab 화면"></img>

### VS Code 사용

1. JupyterLab Launcher 탭에서 **VS Code** 아이콘 클릭

<img src="./images/jupyterhub/image_8_VSCode.png" width="550px" title="VS Code 아이콘" alt="VS Code 아이콘"></img>
...
<img src="./images/jupyterhub/image_GPU_check_VSCode.png" width="550px" title="VS Code GPU 확인" alt="VS Code GPU 확인"></img>
...
<img src="./images/jupyterhub/image_9.png" width="550px" title="Hub Control Panel" alt="Hub Control Panel"></img>

2. 해당 서버의 **Stop** 버튼 클릭

<img src="./images/jupyterhub/image_10.png" width="550px" title="서버 종료" alt="서버 종료"></img>

또는 URL에서 직접: <a href='https://aix-gpu.inha.ac.kr/hub/home' target="_blank">https://aix-gpu.inha.ac.kr/hub/home</a>
